...
class TaskTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.labelColor.text = color[indexPath.row].color
        cell.labelValue.text = color[indexPath.row].value
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath){
        ...
        colorSelected = dataTask.color
        valueSelected = dataTask.value
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "segue"{
            ...
            sendData.passcolorLabel = colorSelected
            sendData.passvalueLabel = valueSelected
    ...
    func parseJsonData(data: Data) -> [Color] {
        ...
        do{
            ...
            let jsonLoans = jsonResult?["color"] as! [AnyObject]
            ...
            for jsonLoan in jsonLoans {
                ...
                let color = color()
                color.Name = jsonLoan["color.Name"] as! String
                color.value = jsonLoan["hexValue"] as! String
